...
function lancer() {
    ...
    let r = parseFloat(document.getElementById("h").value)
    let s = parseFloat(document.getElementById("k").value)
    let c = 0
    let b = -a*(r+s)
    if (isNaN(a) || isNaN(s) || isNaN(r)) {
        document.getElementById("divAffiche").innerText = "Entrez des valeurs pour a, r et s!"
        return
    }
